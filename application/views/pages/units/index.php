                            ...
                            <thead>
                                <tr class="border-0">
                                    <th class="border-0 font-14 font-weight-medium text-muted text-center px-2">Nama
                                        Satuan</th>
                                    <th class="border-0 font-14 font-weight-medium text-muted text-center">Status Satuan
                                    </th>
                                        ...
                                        <td class="border-top-0 text-center px-2 py-4">
                                            <?php if ($row->status == 'valid'): ?>
                                                <i class="fa fa-circle text-success font-12" data-toggle="tooltip"
                                                    data-placement="top" title="Valid"></i>
                                            <?php else: ?>
                                                <i class="fa fa-circle text-danger font-12" data-toggle="tooltip"
                                                    data-placement="top" title="Tidak Valid"></i>
                                            <?php endif ?>
                                        </td>
                    ...
                    <div class="card-footer bg-white">
                        <div class="row">
                            <div class="col-md-6 col-sm-12 mb-2">
                                <a href="<?= base_url('units') ?>" class="btn btn-primary btn-rounded text-white"><i
                                        class="fas fa-angle-left"></i> Daftar Satuan</a>
                            </div>
