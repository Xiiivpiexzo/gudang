                ...
                <div class="card-body">
                        ...
                        <div class="col-lg-12">
                            ...
                            <span>
                                ...
                                <?php foreach (getUnits() as $unit): ?>
                                    <a href="<?= base_url('items/unit/' . $unit->id) ?>"
                                        class="btn btn-rounded btn-primary mt-1 mb-1">
                                        <?= ucfirst($unit->nama) ?>
                                    </a>
                                <?php endforeach ?>
                            </span>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <span>
                                <a href="<?= base_url('items/availability/available') ?>"
                                    class="btn btn-rounded btn-success mt-1 mb-1">Ada</a>
                                <a href="<?= base_url('items/availability/empty') ?>"
                                    class="btn btn-rounded btn-danger mt-1 mb-1">Kosong</a>
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6">
                <div class="card border-primary">
                    <div class="card-header bg-<?= $row->qty > 0 ? 'success' : 'danger' ?>">
                        <h4 class="mb-0 text-white">Barang
                            <?= $row->qty > 0 ? 'Ada' : 'Kosong' ?>
                        </h4>
                    </div>
                    <div class="card-body">
                        <h3 class="card-title">
                        ...
                        <p class="card-text">Jumlah Barang:
                            <?= $row->qty . ' ' . ucfirst($row->nama_satuan) ?>
                        </p>
                        <p class="card-text">Merek Barang:Unknown
                            <!-- <?= $row->nama_supplier ?> -->
                        </p>
                        <div class="row">
                            ...
                            <div class="col-md-6 mt-2">
                                <form action="<?= base_url('cartout/add') ?>" method="POST">
                                    <input type="hidden" name="id_barang" value="<?= $row->id_barang ?>">
                                    <div class="input-group">
                                        <input type="number" name="qty_keluar" min="0" max="<?= $row->qty ?>" value="1"
                                            class="form-control">
                                        <div class="input-group-append">
