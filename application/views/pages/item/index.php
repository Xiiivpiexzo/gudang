...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Stock Barang Baru</h4>
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <label class="input-group-text" for="supplier-options"><i
                                                                class="fas fa-parachute-box"></i></label>
                                                    </div>
                                                    <select class="form-control" name="id_supplier"
                                                        id="supplier-options">
                                                        <?php foreach (getSuppliers() as $supplier): ?>
                                                            <option value="<?= $supplier->id ?>"
                                                                <?= $input->id == $supplier->id ? 'selected' : '' ?>>
                                                                <?= $supplier->nama ?>
                                                            </option>
                                                        <?php endforeach ?>
                                                    </select>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" name="harga" value="<?= $input->harga ?? 0 ?>"
                                                        class="form-control" placeholder="Masukan harga barang"
                                                        required>
                                                </div>
                                            </div>
                                        </div>
