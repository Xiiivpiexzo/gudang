...
/**
 * Kontroller Tambah Satuan Barang
 */
class Unit extends MY_Controller 
{
    ...
    public function index($page = null)
    {
        ...
        if (!$this->unit->validate()) {     // Jika validasi gagal maka arahkan ke form register lagi
            $data['title'] = 'Inv System - Tambah Satuan Barang';
            $data['input'] = $input;
            $data['page']  = 'pages/unit/index';
            $data['breadcrumb_title'] = 'Tambah Satuan Barang';
            $data['breadcrumb_path']  = 'Manajemen Barang / Tambah Satuan Barang';
