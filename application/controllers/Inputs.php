...
class Inputs extends MY_Controller 
{
    ...
    public function index($page = null)
    {
        ...
        $data['title']              = 'Inv System - List Barang Masuk';
    ...
    {
        $data['title']              = 'Inv System - Detail Barang Masuk';
        ...
        // $data['barang_masuk']  = $this->inputs->getBarangMasukDetail($id_barang_masuk);

        // $data['list_barang'] = $this->inputs->getBarangDetailList($id_barang_masuk);
