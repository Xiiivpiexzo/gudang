...
class Units extends MY_Controller 
{
    ...
    public function index($page = null)
    {
        ...
        $data['title']              = 'Inv System - List Satuan';
    ...
    public function search($page = null)
    {
        ...
        $data['title']              = 'Inv System - Cari Staff';
    ...
    public function edit($id)
    {
        ...
        if (!$this->units->validate()) {
            $data['title']              = 'Inv System - Edit Satuan Barang';
    ...
    public function delete($id)
    {
        ...
        // Panggil metode deleteSatuan pada model
        if ($this->units_model->deleteSatuan($id)) {
            // Jika penghapusan berhasil, arahkan ke halaman units
            $this->session->set_flashdata('success', 'Data satuan berhasil dihapus');
        } else {
            // Jika terjadi kesalahan, tampilkan pesan kesalahan
            $this->session->set_flashdata('error', 'Oops! Terjadi suatu kesalahan saat menghapus data satuan');
        }
