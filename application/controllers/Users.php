...
class Users extends MY_Controller 
{
    ...
    public function index($page = null)
    {
        ...
        $data['title']              = 'Inv System - List Teknisi';
        $data['breadcrumb_title']   = 'List Teknisi';
        $data['breadcrumb_path']    = 'Manajemen Teknisi / List Teknisi';
    ...
    public function search($page = null)
    {
        ...
        $data['title']              = 'Inv System - Cari Teknisi';
    ...
    public function edit($id)
    {
        ...
        if (!$this->users->validate()) {
            $data['title']              = 'Inv System - Edit Teknisi';
            $data['page']               = 'pages/users/edit';
            $data['breadcrumb_title']   = 'Edit Data Teknisi';
            $data['breadcrumb_path']    = "Manajemen Teknisi / Edit Data Teknisi / " . $data['input']->nama;
